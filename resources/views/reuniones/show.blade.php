                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800 mt-1">{{ $reunion->actividades->whereNull('deleted_at')->count() }} tareas</p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-800 mt-1">{{ $reunion->invitados->count() }} personas</p>
                        ...
                        <div class="mb-4 last:mb-0 bg-gradient-to-r from-gray-50 to-white border-l-4 border-indigo-500 rounded-xl p-6 hover:shadow-lg transition-all">
                            <div class="flex items-start justify-between gap-4">
                                    ...
                                    <div class="flex flex-wrap gap-4">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-semibold text-gray-800">{{ \Carbon\Carbon::parse($actividad->fecha_entrega)->format('d/m/Y') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-shrink-0">
                                    ...
                                    @endphp
                                    @if($diasRestantes < 0)
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800">Vencida</span>
                                    @elseif($diasRestantes == 0)
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-orange-100 text-orange-800">Hoy</span>
                                    @elseif($diasRestantes <= 3)
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-800">{{ $diasRestantes }} días</span>
                                    @else
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800">{{ $diasRestantes }} días</span>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            <div class="sticky top-24 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        {{-- ✅ ACCESO AL ACTA (visible para todos si existe) --}}
                        @if ($reunion->acta)
                            <a href="{{ route('actas.show', $reunion->acta) }}"
                               class="w-full inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl transition-all shadow-md hover:shadow-lg font-bold group
                               {{ $reunion->acta->estado === 'final' 
                                ...
                                @if ($reunion->acta->estado === 'final')
                                    Ver Acta Final
                                @else
                                    Ver Acta en Borrador
                                @endif
                            </a>
                        @endif
                        ...
                        @if ($reunion->user_id === Auth::id())
                            ...
                            <a href="{{ route('reuniones.dashboard', $reunion) }}"
                            class="w-full inline-flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white rounded-xl transition-all shadow-md font-bold">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <ul class="text-sm text-gray-700 space-y-2">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    La transcripción se activa automáticamente
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg class="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
